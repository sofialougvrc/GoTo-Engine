...
ENGINE_SOURCES := src/catalog.cpp src/coord_transform.cpp src/gpio_interface.cpp src/lgpio_gpio.cpp src/mount.cpp src/step_calibration.cpp src/stepper_axis.cpp src/stepper_mount.cpp src/time_utils.cpp src/tmc2209_config.cpp src/tracking_loop.cpp src/uart_interface.cpp
