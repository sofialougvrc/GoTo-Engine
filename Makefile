...
all: $(SIDEREAL_TEST_BIN) $(ENGINE_TEST_BIN) $(GPIO_TEST_BIN) $(PLATE_SOLVER_TEST_BIN) $(SOFT_LIMITS_TEST_BIN) $(STEP_CALIBRATION_TEST_BIN) $(STEP_SCHEDULER_TEST_BIN) $(STEPPER_TEST_BIN) $(TMC2209_CONFIG_TEST_BIN) $(CLI_BIN)
...
$(PLATE_SOLVER_TEST_BIN): $(ENGINE_SOURCES) tests/plate_solver_tests.cpp include/gte/*.hpp
	@mkdir -p $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) $(LGPIO_CXXFLAGS) $(ENGINE_SOURCES) tests/plate_solver_tests.cpp $(LGPIO_LIBS) -o $(PLATE_SOLVER_TEST_BIN)
...
test: $(SIDEREAL_TEST_BIN) $(ENGINE_TEST_BIN) $(GPIO_TEST_BIN) $(PLATE_SOLVER_TEST_BIN) $(SOFT_LIMITS_TEST_BIN) $(STEP_CALIBRATION_TEST_BIN) $(STEP_SCHEDULER_TEST_BIN) $(STEPPER_TEST_BIN) $(TMC2209_CONFIG_TEST_BIN)
	$(SIDEREAL_TEST_BIN)
	$(ENGINE_TEST_BIN)
	$(GPIO_TEST_BIN)
	$(PLATE_SOLVER_TEST_BIN)
