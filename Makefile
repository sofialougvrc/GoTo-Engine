...
ENGINE_SOURCES := src/catalog.cpp src/coord_transform.cpp src/gpio_interface.cpp src/lgpio_gpio.cpp src/mount.cpp src/step_calibration.cpp src/step_scheduler.cpp src/stepper_axis.cpp src/stepper_mount.cpp src/time_utils.cpp src/tmc2209_config.cpp src/tracking_loop.cpp src/uart_interface.cpp
...
all: $(SIDEREAL_TEST_BIN) $(ENGINE_TEST_BIN) $(GPIO_TEST_BIN) $(STEP_CALIBRATION_TEST_BIN) $(STEP_SCHEDULER_TEST_BIN) $(STEPPER_TEST_BIN) $(TMC2209_CONFIG_TEST_BIN) $(CLI_BIN)
...
test: $(SIDEREAL_TEST_BIN) $(ENGINE_TEST_BIN) $(GPIO_TEST_BIN) $(STEP_CALIBRATION_TEST_BIN) $(STEP_SCHEDULER_TEST_BIN) $(STEPPER_TEST_BIN) $(TMC2209_CONFIG_TEST_BIN)
	$(SIDEREAL_TEST_BIN)
	$(ENGINE_TEST_BIN)
	$(GPIO_TEST_BIN)
